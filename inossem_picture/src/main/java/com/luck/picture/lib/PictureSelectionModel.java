...
public class PictureSelectionModel {
    ...
    /**
     * @param videoQuality video DEFAULT_QUALITY_SIZE and 0 or 1
     * @return
     */
    ...
    /**
     * @param compressQuality crop compress DEFAULT_QUALITY_SIZE default 90
     * @return
     */
    ...
    /**
     * @param startCustomCamera 启动自定义相机
     * @return
     */
    public PictureSelectionModel startCustomCamera(boolean startCustomCamera) {
        selectionConfig.startCustomCamera = startCustomCamera;
        return this;
    }

    /**
     * @param cameraCrop 是否拍照的时候显示裁剪框
     * @return
     */
    public PictureSelectionModel cameraCrop(boolean cameraCrop) {
        selectionConfig.cameraTakingCrop = cameraCrop;
        return this;
    }

    /**
     * @param cameraAdjustLight 是否拍照后 调整亮度
     * @return
     */
    public PictureSelectionModel cameraAdjustLight(boolean cameraAdjustLight) {
        selectionConfig.cameraAdjustLight = cameraAdjustLight;
        return this;
    }

    /**
     * @param takedImmediatelyReturnBack 拍照后不再图片选择页面直接返回  不涉及压缩和裁剪  设置失效
     * @return
     */
