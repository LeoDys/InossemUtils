...
public final class PictureSelectionConfig implements Parcelable {
    ...
    // NEW
    public boolean startCustomCamera;
    ...
    private void reset() {
        ...
        cameraTakingCrop = false;
        cameraAdjustLight = false;
        takedImmediatelyReturnBack = false;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte(this.startCustomCamera ? (byte) 1 : (byte) 0);
        dest.writeByte(this.cameraTakingCrop ? (byte) 1 : (byte) 0);
        dest.writeByte(this.cameraAdjustLight ? (byte) 1 : (byte) 0);
        dest.writeByte(this.takedImmediatelyReturnBack ? (byte) 1 : (byte) 0);
    ...
    protected PictureSelectionConfig(Parcel in) {
        ...
        this.startCustomCamera = in.readByte() != 0;
        this.cameraTakingCrop = in.readByte() != 0;
        this.cameraAdjustLight = in.readByte() != 0;
        this.takedImmediatelyReturnBack = in.readByte() != 0;
