...
import com.luck.picture.lib.camera.camera.InossemCustomCamera;
        ...
        if (cameraIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (config.startCustomCamera) {
                InossemCustomCamera.getInstance()
                        .initActivity(PictureSelectorActivity.this, cameraPath)
                        .setCropCamera(config.cameraTakingCrop)
                        .setLightCamera(config.cameraAdjustLight)
                        .openCamera(PictureConfig.REQUEST_CAMERA);
            } else {
        ...
        if (resultCode == RESULT_OK) {
            ...
            switch (requestCode) {
                ...
                case PictureConfig.REQUEST_CAMERA:
                    ...
                    if (config.takedImmediatelyReturnBack) {
                        medias.add(media);
                        onResult(medias);
                    }
